...
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Slotix";
...
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Slotix";
...
export const DEFAULT_LIGHT_BRAND_COLOR = "#2f6fd0";
export const DEFAULT_DARK_BRAND_COLOR = "#66a6ff";
