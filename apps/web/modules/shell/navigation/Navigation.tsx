...
const getNavigationItems = (): NavigationItemType[] => [
  ...
  {
    // Slotix: no App Store — just "Integrations" (calendars, video, payments, API connections).
    name: "integrations",
    href: "/apps/installed/calendar",
    icon: "grid-3x3",
    moreOnMobile: true,
    isCurrent: ({ pathname: path }) =>
      (path?.startsWith("/apps/installed/") ?? false) || (path?.startsWith("/v2/apps/installed/") ?? false),
  },
  {
